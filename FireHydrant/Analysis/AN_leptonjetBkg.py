...
class LJBkgProcessor(processor.ProcessorABC):
    def __init__(self, data_type='bkg'):
        ...
        ljmass_axis = hist.Bin('ljmass', 'mass [GeV]', 100, 0, 50)
        ...
        self._accumulator = processor.dict_accumulator({
            'lj0pt': hist.Hist('Counts/2', dataset_axis, pt_axis, channel_axis),
            'lj1pt': hist.Hist('Counts/2', dataset_axis, pt_axis, channel_axis),
            'muljmass': hist.Hist('Counts/0.5', dataset_axis, ljmass_axis, channel_axis),
            'muljvxy': hist.Hist('Counts/0.2', dataset_axis, vxy_axis, channel_axis),
            'muljqsum': hist.Hist('Counts', dataset_axis, qsum_axis, channel_axis),
            'ljpairmass': hist.Hist('Counts', dataset_axis, pairmass_axis, channel_axis),
    ...
    def process(self, df):
        ...
        output['ljpairdphi'].fill(dataset=dataset, dphi=(lj0.p4.delta_phi(lj1.p4)).flatten(), channel=channel_, weight=wgt)
